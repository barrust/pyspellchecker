...
class SpellChecker:
    ...
    def __init__(
        ...
        if tokenizer:
            ...
            self._tokenizer = utils._parse_into_words
    ...
    def __contains__(self, key: utils.KeyT) -> bool:
        """setup easier known checks"""
        key = utils.ensure_unicode(key)
        return key in self._word_frequency

    def __getitem__(self, key: utils.KeyT) -> int:
    ...
    def split_words(self, text: utils.KeyT) -> typing.Iterable[str]:
        ...
        text = utils.ensure_unicode(text)
    ...
    def export(self, filepath: str, encoding: str = "utf-8", gzipped: bool = True) -> None:
        ...
        utils.write_file(filepath, encoding, gzipped, data)

    def word_usage_frequency(self, word: utils.KeyT, total_words: typing.Optional[int] = None) -> float:
        ...
        word = utils.ensure_unicode(word)
        return self._word_frequency.dictionary[word] / total_words

    def correction(self, word: utils.KeyT) -> typing.Optional[str]:
    ...
    def candidates(self, word: utils.KeyT) -> typing.Optional[typing.Set[str]]:
    ...
    def known(self, words: typing.Iterable[utils.KeyT]) -> typing.Set[str]:
        ...
        tmp_words = [utils.ensure_unicode(w) for w in words]
    ...
    def unknown(self, words: typing.Iterable[utils.KeyT]) -> typing.Set[str]:
    ...
    def edit_distance_1(self, word: utils.KeyT) -> typing.Set[str]:
        ...
        tmp_word = utils.ensure_unicode(word).lower() if not self._case_sensitive else utils.ensure_unicode(word)
    ...
    def edit_distance_2(self, word: utils.KeyT) -> typing.List[str]:
        ...
        word = utils.ensure_unicode(word).lower() if not self._case_sensitive else utils.ensure_unicode(word)
        return [e2 for e1 in self.edit_distance_1(word) for e2 in self.edit_distance_1(e1)]

    def __edit_distance_alt(self, words: typing.Iterable[utils.KeyT]) -> typing.List[str]:
...
class WordFrequency:
    ...
    def pop(self, key: utils.KeyT, default: typing.Optional[int] = None) -> int:
    ...
    def tokenize(self, text: utils.KeyT) -> typing.Generator[str, None, None]:
        ...
        tmp_text = utils.ensure_unicode(text)
    ...
    def load_dictionary(self, filename: str, encoding: str = "utf-8") -> None:
        ...
        with utils.load_file(filename, encoding) as data:
    ...
    def load_text_file(
        ...
        """
        with utils.load_file(filename, encoding=encoding) as data:
    ...
    def remove_words(self, words: typing.Iterable[utils.KeyT]) -> None:
    ...
    def remove(self, word: utils.KeyT) -> None:
